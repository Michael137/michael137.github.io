...
Note how we have a `nop` in between the `pause` instructions which we can't map back to the source snippet. This translation occur with more interesting functions and loops as well.
