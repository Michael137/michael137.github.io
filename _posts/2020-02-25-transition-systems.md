...
- $$T_0 + T_1 = (S, i, L, \mathit{Tran})$$ where
  ...
  - $$L = L_0 \cupdot L_1$$ with injections $$j_{0}, j_1$$
  - $$t \in \mathit{Tran} \iff \exists (s, \alpha, s') \in \mathit{Tran_0}. t = (\mathit{in_0}(s), j_{0}(\alpha), \mathit{in_0}(s')) \vee \exists (s, \alpha, s') \in \mathit{Tran_1}. t = (\mathit{in_1}(s), j_{1}(\alpha), \mathit{in_1}(s'))$$
